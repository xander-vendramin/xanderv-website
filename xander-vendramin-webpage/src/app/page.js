  ...
  <div
    ...
    <div className="flex h-full items-center justify-center">
      <div className="text-white">
        <h2 className="mb-4 text-4xl font-semibold text-shadow-lg">Xander Vendramin Portfolio</h2>
      </div>
    </div>
  </div>
</div>
      <div className="font-[family-name:var(--font-sans)] text-white bg-gradient-to-bl from-slate-900 to-gray-950 min-h-screen">
        ...
        <div className="w-2/3 justify-self-center p-5 mt-10 border-6 border-solid rounded-lg shadow-lg text-xl bg-slate-700 border-slate-800">
          <p>
          ...
          <a href="https://github.com/xander-vendramin" target="_blank">
            <button type="button" data-twe-ripple-init data-twe-ripple-color="light" className="inline-block rounded bg-[#333] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">

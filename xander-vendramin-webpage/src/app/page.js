...
export default function Home() {
  ...
  <div className="sm:hidden" id="mobile-menu">
    <div className="space-y-1 px-2 pb-3">
      <a href="\" className="text-center justify-self-center block w-1/3 rounded-md bg-gray-900 px-3 py-2 font-medium font-[family-name:var(--font-oswald)] text-white" aria-current="page">Home</a>
      <a href="/projects" className="text-center justify-self-center block w-1/3 rounded-md px-3 py-2 font-medium font-[family-name:var(--font-oswald)] text-gray-300 hover:bg-gray-700 hover:text-white">Projects</a>
    </div>
  </div>
</nav>
<div

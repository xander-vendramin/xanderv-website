...
export default function Home() {
  ...
  <div className="sm:hidden" id="mobile-menu">
    <div className="space-y-1 px-2 pb-3">
      <a href="\" className="text-center m-auto block w-1/3 rounded-md bg-gray-900 px-3 py-2 font-medium font-[family-name:var(--font-oswald)] text-white" aria-current="page">Home</a>
      <a href="/projects" className="text-center m-auto self-center block w-1/3 rounded-md px-3 py-2 font-medium font-[family-name:var(--font-oswald)] text-gray-300 hover:bg-gray-700 hover:text-white">Projects</a>
    </div>
  </div>
</nav>
<div
  ...
  <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-black/60 bg-fixed">
    <div className="flex h-full backdrop-blur-md items-center justify-center">
      <div className="text-white">
        <h2 className="mb-4 text-5xl font-semibold font-[family-name:var(--font-oswald)] text-shadow-lg animate-fadeIn">Portfolio of Xander Vendramin</h2>
      </div>
    </div>
  </div>
</div>
      <div className="absolute -z-10 font-[family-name:var(--font-roboto)] text-white bg-cover bg-[url('https://images.pexels.com/photos/346529/pexels-photo-346529.jpeg')] min-h-screen">
        <div className="backdrop-blur-md min-h-screen">
          <div className="animate-fadeInUp z-1 mr-3 ml-3 lg:w-2/3 place-self-center p-3 mt-4 border-2 border-solid rounded-lg shadow-lg text-xl bg-linear-to-t from-slate-700 to-slate-600 border-slate-700">
            <p>
            ...
            where I can produce consistent and efficient work. <br></br> <br></br> I have experience with many different types of programming. I am
            experienced in full stack web development and specialize in using NextJS/React (This website is made using NextJS!). I am also experienced in software developemnt
            ...
            with on my resume. The projects tab of this website has a few examples of past and current examples of my work. If you have any other
            questions for me, please feel free to contact me by email or phone. <br></br> Thanks for visiting, have a great day!
            </p>
            <br></br>
            <p>
